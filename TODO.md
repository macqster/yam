...
- [inspect] define a conservative render-loop efficiency plan: keep one long-lived `Scene`, avoid rebuilding the boxed layer stack every frame, and investigate reusable `Grid` scratch/final buffers before touching broader rendering contracts.
