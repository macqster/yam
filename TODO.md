...
- [inspect] continue the render-loop efficiency pass after the first `Scene` reuse slice: investigate reusable `Grid` scratch/final buffers and decide whether closed modal layers should also be skipped before `render_to_grid()` is called.
