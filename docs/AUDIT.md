...
- The active debug border is now a stable ASCII frame probe, matching the repo's world datum and quadrant split more clearly than the earlier dotted edge markers.
