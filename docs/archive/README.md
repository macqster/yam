...
This folder holds older reports and update notes that are kept for historical context.
...
- Keep active contracts in `docs/SCENE_MODEL.md`, `docs/ARCHITECTURE.md`, `docs/TODO.md`, and `docs/LOG.md`.
