...
- The historical 2026-08-19 measurement recorded `hero_gif_1` frame 0 at 1918/4608 cells (41.6%, floor 20%) and `hero_gif_2` at 923/4608 (20.0%, floor 10%) under the then-active policies. The current vector policy measures 1725/4608 (37.4%) after the 2026-09-09 correction; the old lower value was caused by deliberate overlap, not a hardware-specific difference.
