...
- Measured 2026-08-19 against chafa 1.18.2, through the test's own `covered_cells` helper, after the `absent_color` fix: `hero_gif_1` frame 0 covers 1918/4608 cells (41.6%, floor 20%), `hero_gif_2` covers 1716/4608 (37.2%, floor 10%). Before that fix the same measurement gave 932 (20.2%) and 706 (15.3%) — the pipeline was discarding a little over half of each hero.
